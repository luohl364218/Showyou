...
public class SchoolData {
    ...
    public static String[] allAreaGroup = new String[]{"北京市","天津市","河北省","山西省","内蒙古","上海市","江苏省","浙江省","安徽省","福建省","江西省","山东省",
            "辽宁省","吉林省","黑龙江省","河南省","湖北省","湖南省","广东省","广西","海南省","重庆市","四川省","贵州省","云南省","西藏","陕西省","甘肃省","青海省",
            "宁夏","新疆","香港","澳门"};
    ...
    public static String[] fujianSchools = new String[]{"全部","厦门大学","福州大学","华侨大学","福建医科大学"};

    public static String[] jiangxiSchools = new String[]{"全部","南昌大学","华东交通大学","南昌航空大学","江西农业大学","江西师范大学"};

    public static String[] shangdongSchools = new String[]{"全部","山东大学","中国海洋大学","中国石油大学","山东科技大学"};

    public static String[] liaoningSchools = new String[]{"全部","大连理工大学","东北大学","东北大学","大连海事大学"};
    ...
    public static String[] hainanSchools = new String[]{"全部","海南大学","海南师范大学"};
    ...
    public static String[] yunnanSchools = new String[]{"全部","云南大学","昆明理工大学","云南农业大学"};
    ...
    public static String[] qinghaiSchools = new String[]{"全部","青海大学","青海师范大学"};

    public static String[] ningxiaSchools = new String[]{"全部","宁夏大学","宁夏医学院","宁夏师范学院"};

    public static String[] xinjiangSchools = new String[]{"全部","新疆大学","石河子大学","塔里木大学","新疆农业大学"};

    public static String[] xianggangSchools = new String[]{"全部","香港城市大学","香港中文大学","香港科技大学","香港大学"};
