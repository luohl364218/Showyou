...
public enum VerifyStateType {
    ...
    public VerifyStateType getVerifyStateType(int mVerifyId) {
        for (VerifyStateType verifyStateType : VerifyStateType.values()) {
            if (mVerifyId == verifyStateType.getVerifyId()) {
                return verifyStateType;
            }
        }
        return null;
    }
