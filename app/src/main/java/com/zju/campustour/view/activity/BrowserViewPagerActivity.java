...
import com.zju.campustour.view.chatting.photoview.PhotoView;
import com.zju.campustour.view.chatting.widget.ImgBrowserViewPager;
        ...
        mPictureSelectedCb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if (mSelectMap.size() + 1 <= 9) {
                    ...
                    showToast(mContext.getString(R.string.picture_num_limit_toast));
                    mPictureSelectedCb.setChecked(mSelectMap.get(currentItem));
                } else {
                    mSelectMap.delete(currentItem);
                }
...
//        }
    ...
    private void initCurrentItem() {
        if (!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            showToast(this.getString(R.string.jmui_local_picture_not_found_toast));
        }
