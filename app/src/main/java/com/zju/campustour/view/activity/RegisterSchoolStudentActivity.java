...
public class RegisterSchoolStudentActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_school_student);
        ...
        rxPermissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE)
                .subscribe(new Observer<Boolean>() {
                    ...
                    public void onNext(Boolean aBoolean) {
                        if (aBoolean) {
                            Matisse.from(RegisterSchoolStudentActivity.this)
    ...
    protected void updateUserInfo() {
        ...
        currentUser.put(Constants.User_identityType, IdentityType.SCHOOL_STUDENT.getIdentityId());
        ...
        currentUser.put("shortDescription","我是一名" +grade+"学生");
        currentUser.put("description","我是一名" + schoolName +grade+"学生");
        //上传极光 用户性别 个性签名  生活地区
        try {
            ...
            myUserInfo.setNickname("校游中小学生 "+userRealName);
            ...
            myUserInfo.setSignature("我是一名" + schoolName +grade+"学生");
