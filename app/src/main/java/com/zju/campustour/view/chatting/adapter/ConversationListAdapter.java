    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (TextUtils.isEmpty(draft)) {
            ...
            if (lastMsg != null) {
                ...
                if (mArray.get(position) && CampusTourApplication.isNeedAtMsg) {
                    //有人@我 文字提示
        ...
        if (convItem.getUnReadMsgCnt() > 0) {
          /*  unreadMsg += convItem.getUnReadMsgCnt();*/
             EventBus.getDefault().post(new UnreadMsgEvent(convItem.getUnReadMsgCnt()));
