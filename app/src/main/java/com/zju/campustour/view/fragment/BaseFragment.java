...
public class BaseFragment extends Fragment {
    ...
    public void onEventMainThread(LoginStateChangeEvent event) {
        ...
        if (null != myInfo) {
            ...
            SharePreferenceManager.putString(getContext(), Constants.DB_USERNAME, myInfo.getUserName());
            SharePreferenceManager.putString(getContext(),Constants.DB_USERIMG, path);
