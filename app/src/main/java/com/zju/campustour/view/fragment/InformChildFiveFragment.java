...
/*显示线上活动*/
public class InformChildFiveFragment extends BaseFragment implements ISearchProjectInfoView {

    private String TAG = "InformChildFiveFragment";
    ...
    private void loadMoreProjectInfoData() {
        ...
        mProjectInfoPresenter.getLimitProjectInfo(mProjectAdapter.getDatas().size(),10,isLatest,isHotest,false,false);
        isRefreshing = false;
    }
    ...
    private void refreshProjectItemInfoData() {
        ...
        mProjectInfoPresenter.getLimitProjectInfo(0,10,isLatest,isHotest,false,false);
    }
