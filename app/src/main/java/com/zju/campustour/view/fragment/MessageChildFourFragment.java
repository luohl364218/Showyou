...
public class MessageChildFourFragment extends BaseFragment implements INewsShowView {

    private String TAG = "MessageChild4Fragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mRootView == null) {
            mRootView = inflater.inflate(R.layout.fragment_message_child_four, container, false);
