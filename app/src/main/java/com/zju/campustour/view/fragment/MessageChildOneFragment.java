...
public class MessageChildOneFragment extends BaseFragment implements INewsShowView {

    private String TAG = "MessageChildOneFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mRootView == null) {
            mRootView = inflater.inflate(R.layout.fragment_message_child_one, container, false);
