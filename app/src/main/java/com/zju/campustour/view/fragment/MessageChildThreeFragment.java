...
public class MessageChildThreeFragment extends BaseFragment implements INewsShowView {

    private String TAG = "MessageChild3Fragment";
    ...
    NewsType mType = NewsType.SCIENCE;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mRootView == null) {
            mRootView = inflater.inflate(R.layout.fragment_message_child_three, container, false);
