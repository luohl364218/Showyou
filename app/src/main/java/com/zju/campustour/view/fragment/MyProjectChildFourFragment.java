...
public class MyProjectChildFourFragment extends BaseFragment implements ISearchProjectInfoView {
    ...
    private String tabName = "你还没有已经完成的活动";
    private boolean isCurrentTabMine = false;
    private boolean isRefreshing = false;
    private int state = STATE_NORMAL;
    private UserProjectStateType type = FINISHED;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mRootView == null) {
            mRootView = inflater.inflate(R.layout.fragment_my_project_child_four, container, false);
