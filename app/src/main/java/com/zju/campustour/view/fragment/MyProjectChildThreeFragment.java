...
public class MyProjectChildThreeFragment extends BaseFragment implements ISearchProjectInfoView {
    ...
    private String tabName = "你预约的活动为空哦，快去预约吧";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mRootView == null) {
            mRootView = inflater.inflate(R.layout.fragment_my_project_child_three, container, false);
