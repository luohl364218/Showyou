...
public class MyProjectChildTwoFragment extends BaseFragment implements ISearchProjectInfoView {
    ...
    private String tabName = "你还没有收藏活动哦，快去收藏吧";
    private boolean isCurrentTabMine = false;
    private boolean isRefreshing = false;
    private int state = STATE_NORMAL;
    private UserProjectStateType type = COLLECT;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mRootView == null) {
            mRootView = inflater.inflate(R.layout.fragment_my_project_child_two, container, false);
