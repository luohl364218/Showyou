...
public class MySchoolmateChildOneFragment extends BaseFragment implements ISearchUserInfoView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mRootView == null) {
            mRootView = inflater.inflate(R.layout.fragment_my_schoolmate_child_one, container, false);
